...
|:---|:--:|:-----|:-----|
| **Quality** | **GPU** | **High หรือ Very High** - ย้ายงานไปให้ GPU | ลดเป็น Low/Medium ได้ |
| **Planet Volumetric Clouds** | **GPU<br>(สูงมาก)** | Medium (เพื่อภาพสวย) | **Medium หรือ Off** - ลดนี้ก่อนอย่างอื่น |
| **Resolution** | **GPU** | <center> - </center> | **เท่าความละเอียดหน้าจอ**<br>แต่ไปใช้ Upscale จะได้ผลดีกว่า |
| **Upscaling (DLSS/FSR)** | **GPU** | <center> - </center> | **DLSS/FSR ตามยี่ห้อ GPU**<br>ช่วยลด GPU load มาก ลองที่ Quality ก่อน ถ้ายังหนัก GPU อยู่ให้ปรับเป็น Performance จะช่วยได้อีก |
